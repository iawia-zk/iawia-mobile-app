...
import { getFriendlyName, getSecpFromNist } from '../../ellipticCurves/oids';
import { CertificateData, PublicKeyDetailsECDSA } from './parseCertificate.types';
import {
  getCurveForElliptic,
  getECDSACurveBits,
  identifyCurve,
  StandardCurve,
} from '../../ellipticCurves/ellipticCurves';
import { getIssuerCountryCode, getSubjectKeyIdentifier } from '../parseUtils';
import { circuitNameFromMode } from 'constants/hash';
import { Mode } from '../../appType/appType';
