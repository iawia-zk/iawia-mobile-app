...
} from './parseCertificates/parseDscCertificate';
import { brutforceSignatureAlgorithm } from './parseSignatures/bruteForcePassportSignature';
...
export function getCurveOrExponent(certData: CertificateData): string {
  if (certData.signatureAlgorithm === 'rsapss' || certData.signatureAlgorithm === 'rsa') {
    console.log('RSA signature algorithm detected, currently unsupported');
    return '';
  }
