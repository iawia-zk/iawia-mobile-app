...
template PassportVerifier(DG_HASH_ALGO, ECONTENT_HASH_ALGO, MAX_ECONTENT_PADDED_LEN, MAX_SIGNED_ATTR_PADDED_LEN) {
    var n = 66;
    var k = 8;
    ...
    SignatureVerifier()(signedAttrShaBits, pubKey_dsc, signature_passport);
}
